...
<span class="image fit"><img src="/assets/images/lab1.png" alt="The view of the VNE in VMWare Workstation." width="602" height="533" /></span>
...
<span class="image fit"><img src="/assets/images/lab2.png" alt="Windows Install Screen." width="341" height="255" /></span>
...
<span class="image fit"><img src="/assets/images/lab3.png" alt="Network Properties view for IPV4." width="416" height="464" /></span>
...
4. Right click Forward Lookup *Zones → New Zone*.
    ...
    <span class="image fit"><img src="/assets/images/lab4.png" alt="DNS Forward Lookup Zone Creation." width="330" height="232" /></span>
...
8. Now right click on the right hand side → New Host (A or AAAA)....
   ...
   <span class="image fit"><img src="/assets/images/lab5.png" alt="The view of the Forward Lookup Zone in DNS Manager." width="551" height="381" /></span>
9. Insert IP address of “esxi” node if/when installed.
10. Add host.
11. Repeat the above for "vcsa".

<span class="image fit"><img src="/assets/images/lab6.png" alt="Creating Reverse Lookup Zones for the relevant records." width="363" height="317" /></span>
...
<span class="image fit"><img src="/assets/images/lab7.png" alt="PTR Record Lookup." width="401" height="368" /></span>
...
<span class="image fit"><img src="/assets/images/lab8.png" alt="Reverse Record and Forward Record Zones in DNS Manager." width="506" height="275" /></span>
...
9. Networking Configuration (Fill these in from top down).
    ...
    <span class="image fit"><img src="/assets/images/lab9.png" alt="VMWare vSphere Login Page for ESXi." width="477" height="308" /></span>
...
<span class="image fit"><img src="/assets/images/lab10.png" alt="Virtual Machine Import for vCSA." width="415" height="340" /></span>
...
<span class="image fit"><img src="/assets/images/lab11.png" alt="vCSA's DCUI. Very similar to ESXI's, now in "Blue"." width="446" height="330" /></span>

## ESXi and vCSA Are Now Installed

VM will complete set up and provide link to access. 

<span class="image fit"><img src="/assets/images/lab12.png" alt="Setup is in progress." width="496" height="290" /></span>

Click on the Flash based weblink. 

<span class="image fit"><img src="/assets/images/lab13.png" alt="Click on the "Appliance Getting Started Page" URL." width="500" height="299" /></span>
